...
public class Turtle implements KeyEventDispatcher {
	...
	private void spaceBarWasPressed() {
		...
		if(490<tortoiseLocationX && tortoiseLocationX<520 && tortoiseLocationY>280 && tortoiseLocationY<355){
			JOptionPane.showMessageDialog(null, "Now go to the boy in blue.");
			
		}
		if(tortoiseLocationX<160 && tortoiseLocationX<130 && tortoiseLocationY<340 && tortoiseLocationY>265){
			JOptionPane.showMessageDialog(null, "Go to the swamp and talk to the fish or you can go to the parrots.");
